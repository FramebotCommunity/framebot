...
int _video(){
	...
	fflush(stdout);
	result = send_video_chat(_bot, chat_id, filename, 0, 0, 0, NULL, NULL, RAW, 0, ON, 0, NULL);
	if(result){
		printf(BLUE "OK\n" COLOR_RESET);
		message_free(result);
	}
	...
	fflush(stdout);
	result = send_video_chat(_bot, chat_id, filename, 10, 0, 0, NULL, NULL, RAW, 0, ON, 0, NULL);
	if(result){
		printf(BLUE "OK\n" COLOR_RESET);
		message_free(result);
	}
	...
	fflush(stdout);
	result = send_video_chat(_bot, chat_id, filename, 10, 10, 0, NULL, NULL, RAW, 0, ON, 0, NULL);
	if(result){
		printf(BLUE "OK\n" COLOR_RESET);
		message_free(result);
	}
	...
	fflush(stdout);
	result = send_video_chat(_bot, chat_id, filename, 10, 10, 10, NULL, NULL, RAW, 0, ON, 0, NULL);
	if(result){
		printf(BLUE "OK\n" COLOR_RESET);
		message_free(result);
	}
	...
	fflush(stdout);
	result = send_video_chat(_bot, chat_id, filename, 10, 10, 1, NULL, "caption", RAW, 0, ON, 0, NULL);
	if(result){
		printf(BLUE "OK\n" COLOR_RESET);
		message_free(result);
	}
	...
	fflush(stdout);
	result = send_video_chat(_bot, chat_id, filename, 10, 10, 1, NULL, "<b>caption</b>", RAW, 0, ON, 0, NULL);
	if(result){
		printf(BLUE "OK\n" COLOR_RESET);
		message_free(result);
	}
	...
	fflush(stdout);
	result = send_video_chat(_bot, chat_id, filename, 10, 10, 1, NULL, "caption", RAW, 1, ON, 0, NULL);
	if(result){
		printf(BLUE "OK\n" COLOR_RESET);
		message_free(result);
	}
	...
	fflush(stdout);
	Message *forward = send_video_chat(_bot, chat_id, filename, 10, 10, 1, NULL, "caption", RAW, 1, ON, result->message_id, NULL);
	if(forward){
		printf(BLUE "OK\n" COLOR_RESET);
